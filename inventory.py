...
# ── Defaults ──────────────────────────────────────────────────────────────────
FORECAST_CSV   = "outputs/submission_nbeats.csv"
TRAIN_CSV      = "data/train.csv"
OUTPUT_CSV     = "outputs/inventory_plan.csv"
...
def main():
    ...
    print("Loading unit cost từ training data ...")
    cost_df = load_unit_cost(TRAIN_CSV)
